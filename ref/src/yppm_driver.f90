...
contains
  ...
  new_jsd = idims(3)
  new_jed = idims(4)
  ! Interpolate the four two-dimensional arrays to their larger 2-dimensional arrays.
  ! This is a simple linear approximation.  No fancy polynomial approximations.
  
  ! print *,"cry=",shape(cry),isd,ied,js,je
  ! print *,"q=",  shape(q),  isd,ied,jsd,jed
  ! print *,"dya=",shape(dya),isd,ied,jsd,jed
  ! print *,"fy2=",shape(fy2),isd,ied,js,je

  ! print *,"new_cry=",shape(new_cry),new_isd,new_ied,new_js,new_je
  ! print *,"new_q=",  shape(new_q),new_isd,new_ied,new_jsd,new_jed
  ! print *,"new_dya=",shape(new_dya),new_isd,new_ied,new_jsd,new_jed
  ! print *,"new_fy2=",shape(new_fy2),new_isd,new_ied,new_js,new_je
