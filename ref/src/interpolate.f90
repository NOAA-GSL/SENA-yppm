...
contains
  ...
  implicit none
    ...
    ! call interpolate_array(originalArray, odims, interpolatedArray, idims, interpFactor)
  ...
  subroutine interpolate_array(originalArray, odims, interpolatedArray, idims, interpFactor)
    ...
    ! Subroutine to interpolate interpolatedArray from the originalArray with
    ! regard to interpFactor.
    ! This is a simple linear approximation.  No fancy polynomial
    ! approximations.  We are assuming that the grid points are equally
    ! spaced.
    !
